---
name: claude-obsidian-wiki-ingest
description: "Hermes port of claude-obsidian `wiki-ingest`. Ingest sources into the Obsidian wiki vault. Reads a source, extracts entities and concepts, creates or updates wiki pages, cross-references, and logs the operation. Supports files, URLs, and batch mode. Triggers on: ingest, process this source, add this to the wiki, read and file this, batch ingest, ingest all of these, ingest this url."
version: 0.1.0-port
...
- **filesystem** — Hermes `write_file`/`Edit` tools with absolute vault-rooted paths (final floor; always works)
