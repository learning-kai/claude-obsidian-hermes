...
- **filesystem** — Hermes `write_file` tool with absolute path
...
The Hermes Agent `WebFetch` tool has built-in defenses against many of these. Apply them here as defense-in-depth.
